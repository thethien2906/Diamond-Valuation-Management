  ...
  return (
    <GuestLayout>
      ...
      >
        <Typography
          variant="h1"
          sx={{ fontFamily, fontWeight: 'bold', fontSize: '8rem' }}
          data-aos="fade-up"
        >
          DiamondScope
        </Typography>
      ...
      >
        ...
        >
          <Box sx={{ flex: 1, paddingRight: { md: '20px' }, paddingBottom: { xs: '20px', md: '0' } }}>
            <Typography variant="h2" gutterBottom sx={{ fontFamily, fontWeight: 'bold', color: '#033F63' }}>
              ABOUT DIAMONDSHINE
            </Typography>
        ...
        >
          <Box sx={{ flex: 1, paddingLeft: { md: '20px' }, paddingBottom: { xs: '20px', md: '0' }, position: 'absolute', top: '40%', left: '20%', right: '-45%', marginLeft: '400px', transform: 'translate(-50%, -50%)', color: '#fff', backgroundColor: 'rgba(0, 0, 0, 0)', padding: '20px', borderRadius: '10px', zIndex: 1 }}>
            <Typography variant="h3" gutterBottom sx={{ fontFamily, fontWeight: 'bold', color: '#fff' }}>
              OUR MISSION
            </Typography>
        ...
        >
          <Box sx={{ flex: 1, paddingRight: { md: '20px' }, paddingBottom: { xs: '20px', md: '0' } }}>
            <Typography variant="h2" gutterBottom sx={{ fontFamily, fontWeight: 'bold', color: '#033F63', marginTop: '50px' }}>
